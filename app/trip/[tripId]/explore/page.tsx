...
/**
 * Explore, in whichever mode this trip is in.
 *
 ...
 * impossible: a trip whose Overview came from the server and whose explore came
...
export default async function Page({
  ...
  if (shared.kind === "OK") {
    return (
      <SharedShell trip={shared.trip} actor={shared.actor} current="explore">
        <SharedScreen
          screen="explore"
          trip={shared.trip}
          actor={shared.actor}
  ...
  return <LocalScreen tripId={tripId} screen="explore" />;
}

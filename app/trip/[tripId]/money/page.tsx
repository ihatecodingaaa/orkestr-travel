...
/**
 * Money, in whichever mode this trip is in.
 *
 ...
 * impossible: a trip whose Overview came from the server and whose money came
...
export default async function Page({
  ...
  if (shared.kind === "OK") {
    return (
      <SharedShell trip={shared.trip} actor={shared.actor} current="money">
        <SharedScreen
          screen="money"
          trip={shared.trip}
          actor={shared.actor}
  ...
  return <LocalScreen tripId={tripId} screen="money" />;
}

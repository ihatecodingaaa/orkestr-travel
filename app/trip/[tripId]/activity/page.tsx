...
/**
 * Activity, in whichever mode this trip is in.
 *
 ...
 * impossible: a trip whose Overview came from the server and whose activity came
...
export default async function Page({
  ...
  if (shared.kind === "OK") {
    return (
      <SharedShell trip={shared.trip} actor={shared.actor} current="activity">
        <SharedScreen
          screen="activity"
          trip={shared.trip}
          actor={shared.actor}
  ...
  return <LocalScreen tripId={tripId} screen="activity" />;
}

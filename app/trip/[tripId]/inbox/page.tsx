...
/**
 * The inbox, in whichever mode this trip is in.
 *
 ...
 * impossible: a trip whose Overview came from the server and whose inbox came
...
export default async function Page({
  ...
  if (shared.kind === "OK") {
    return (
      <SharedShell trip={shared.trip} actor={shared.actor} current="inbox">
        <SharedScreen
          screen="inbox"
          trip={shared.trip}
          actor={shared.actor}
  ...
  return <LocalScreen tripId={tripId} screen="inbox" />;
}
